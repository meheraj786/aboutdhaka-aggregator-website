...
export const PLACES: Place[] = [
  {
    ...
    rating: 4.8,
    reviews: 1240,
    description: 'The official residential palace and seat of the Nawab of Dhaka, a stunning example of Indo-Saracenic Revival...',
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 2150,
    description: 'An incomplete 17th-century Mughal fort complex that stands as a symbol of Dhaka\'s rich imperial history.',
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 5400,
    description: 'A popular waterfront area for recreation, offering scenic boat rides and illuminated bridges at night.',
    longDescription: 'Hatirjheel is a lakefront in Dhaka, Bangladesh that has been transformed into a major recreation area. Before 2013, it was a slum area that has been transformed into a modern transportation and recreation hub. It is now one of the most popular places for residents to visit in the evening.',
...
export const SHOPPING_MALLS: ShoppingMall[] = [
  {
    ...
    rating: 4.8,
    reviews: 15200,
    description: 'The largest shopping mall in South Asia, offering a massive range of local and international brands.',
    ...
    facilities: ['Cineplex', 'Indoor Theme Park', 'Food Court', 'Prayer Room', 'Parking'],
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 12400,
    description: 'A premier shopping destination in the heart of Dhaka, known for its iconic architecture and variety.',
    longDescription: 'Bashundhara City is a shopping mall in Dhaka, and the second largest shopping mall in Bangladesh. It was opened in 2004. The mall has 19 floors, including a basement. It features over 2,500 shops, a large food court, a cineplex, and a fitness center. It is one of the most visited shopping malls in the city.',
    ...
    facilities: ['Cineplex', 'Gym', 'Food Court', 'Underground Parking', 'Escalators'],
  ...
  },
  {
    ...
    rating: 4.5,
    reviews: 3200,
    description: 'A modern shopping complex in Dhanmondi, popular for its food court and boutique shops.',
    longDescription: 'Shimanto Sombor is a popular shopping mall located in the Dhanmondi area of Dhaka. It is known for its wide range of clothing boutiques, electronics shops, and a vibrant food court on the top floor. It is a favorite hangout spot for students and families living in Dhanmondi.',
