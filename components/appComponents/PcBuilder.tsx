      ...
      <div className="max-w-7xl mx-auto bg-[#0a1128] rounded-[40px] p-12 md:p-24 overflow-hidden relative">
        <div className="z-10 relative max-w-2xl">
          ...
          <p className="text-slate-400 text-xl leading-relaxed mb-12">
            Our expert-led PC building service helps you choose the perfect components for gaming, work, or creative projects.
          </p>
          
          <div className="flex flex-wrap gap-4">
            <button type="button" className="bg-blue-600 text-white font-bold px-10 py-5 rounded-2xl hover:bg-blue-700 transition-colors shadow-lg shadow-blue-900/20">
              Start Building
            </button>
            <button type="button" className="bg-slate-800 text-white font-bold px-10 py-5 rounded-2xl hover:bg-slate-700 transition-colors">
              Talk to Expert
            </button>
          </div>
        </div>
