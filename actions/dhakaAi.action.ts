...
async function queryDoctors(params: Record<string, string>) {
	...
	let matchedHospital: Record<string, unknown> | null = null;
	...
	const hospitalFilters: Record<string, unknown> = { isActive: true };
	if (params.area)
	...
	let hospitalQuery: Record<string, unknown> = { isActive: true };
	if (
...
async function generateResponse(
	...
	if (
		...
		const hospital = (dbResults as { hospital: Record<string, unknown> })
			.hospital;
