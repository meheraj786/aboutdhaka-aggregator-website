				...
				<div className="space-y-8">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							{USAGE_OPTIONS.map((option) => (
								<button
									...
									key={option.id}
									onClick={() =>
										setFormData((prev) => ({ ...prev, mainUsage: option.id }))
									}
									className={cn(
					...
					<section className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
						...
						<div className="space-y-10">
							{/* Browser Tabs */}
							<div>
								<div className="block text-sm font-semibold text-slate-700 mb-4">
				...
				<aside className="space-y-6 lg:sticky lg:top-8">
					...
					<div className="bg-[#0F172A] rounded-2xl p-6 text-white shadow-xl overflow-hidden relative">
						...
						<div className="relative z-10">
							...
							<div className="mt-8 p-4 bg-white/5 rounded-xl border border-white/10 text-[11px] leading-relaxed text-white/60 italic">
								&quot;Based on your 20+ tabs and gaming focus, we&apos;ve
								prioritized high-speed RAM and a powerful graphics card.&quot;
							</div>
						</div>
					</div>
					...
					<div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
						...
						<div className="p-6 pt-0 text-center relative z-10 -mt-8">
							...
							<button
								type="button"
								className="w-full py-3 bg-slate-50 text-slate-900 font-bold rounded-xl border border-slate-200 hover:bg-slate-100 transition-colors"
							>
			...
			<section className="bg-white border-t border-slate-200 py-20 mt-10">
				<div className="max-w-7xl mx-auto px-6 text-center">
					...
					<p className="max-w-2xl mx-auto text-slate-500 text-lg leading-relaxed mb-12">
						This configuration is tailor-made for high-frame-rate gaming at
						1440p while handling heavy multitasking and software development
						with ease.
					</p>
						...
						{[
							{
								...
								desc: "Perfect for heavy multitasking and CPU-intensive games.",
								icon: Cpu,
							},
							{
								label: "Graphics",
								title: "RTX 4070 Ti",
								desc: "Unmatched 1440p performance with ray-tracing capabilities.",
								icon: Monitor,
							},
							{
								label: "Memory",
								title: "32GB DDR5 6000MHz",
								desc: "Future-proof capacity for Chrome tabs and 4K editing.",
								icon: MemoryStick,
							},
							{
								label: "Storage",
								title: "2TB Gen4 NVMe SSD",
								desc: "Blazing fast load times and plenty of game storage.",
								icon: HardDrive,
							},
						].map((spec) => (
							<div
