        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-slate-400 leading-relaxed font-medium">
              {doctor.designation}. Expert in{" "}
              {doctor.speciality?.join(", ") || "Advanced Healthcare"}.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="bg-white rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50 overflow-hidden">
              <div className="aspect-[4/5] relative bg-slate-100">
                <Image
                  ...
                  src={
                    doctor.profileImage ||
                    "https://avatar.iran.liara.run/public/doctor"
                  }
                  alt={doctor.name}
                ...
                <div className="space-y-6 mb-8">
                  ...
                  <div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <Link
                          href={`/hospitals/${doctor.chamber?.[0]?._id}`}
            ...
            <section className="bg-white rounded-3xl border border-slate-100 p-10 shadow-sm">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-slate-50 rounded-2xl p-6 text-center border border-slate-100 transition-colors">
                  ...
                  <p className="text-sm font-black text-emerald-600 uppercase pt-2">
                    Active
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <div className="space-y-4">
                {doctor.chamber?.map(
                  (hosp: {
                    name: string;
                    address: { area: string; district: string, coordinates?: { lat?: number; lng?: number } };
                  }) => (
                    <div
                      key={hosp.name}
                      className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm flex flex-col md:flex-row justify-between items-center gap-6"
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium text-slate-500">
                            {hosp.address?.area}, {hosp.address?.district}
                          </p>
                        </div>
                      </div>
                      {hosp.address?.coordinates?.lat &&
                        hosp.address?.coordinates?.lng && (
                          <FindBusButton
