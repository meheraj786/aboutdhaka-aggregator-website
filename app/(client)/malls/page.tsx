...
const mallsData = [
	{
		...
		rating: 4.8,
		description:
			"The largest shopping mall in South Asia with a wide range of brands.",
		image:
	...
	},
	{
		...
		rating: 4.7,
		description:
			"A major shopping destination with a cinema hall and food court.",
		image:
	...
	},
	{
		...
		rating: 4.5,
		description:
			"A popular shopping mall with a variety of local and international brands.",
		image:
			"https://images.unsplash.com/photo-1580793241553-e9f1cce181af?auto=format&fit=crop&q=80&w=800",
	},
	{
					...
					<div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
						<div>
							...
							<p className="text-slate-500">
								Find everything you need at the best shopping destinations.
							</p>
						</div>
