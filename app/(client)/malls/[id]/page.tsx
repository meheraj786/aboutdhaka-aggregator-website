...
export default function ShoppingMallDetailPage({
	params,
}: {
			...
			<div className="min-h-screen flex items-center justify-center bg-slate-50 pt-24">
				<div className="text-center">
					...
					<p className="text-slate-500 mb-6">
						The shopping mall you are looking for doesn&apos;t exist.
					</p>
					<Link
						href="/shopping-malls"
	...
	const nearbyMalls = SHOPPING_MALLS.filter(
		(m) => m.id !== id && m.area === mall.area,
	).slice(0, 2);
				...
				<div className="absolute bottom-8 left-4 right-4 sm:left-8 sm:right-8 max-w-7xl mx-auto">
					<div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
						...
						<div className="flex items-center gap-3">
							...
							<button
								type="button"
								className="flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-full font-bold hover:bg-blue-700 transition-all shadow-xl shadow-blue-900/20"
							>
