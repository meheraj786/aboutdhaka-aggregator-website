...
const doctorsByDept = hospital?.doctors?.reduce((acc: any, doctor: any) => {
	...
	return (
		<div className="min-h-screen bg-slate-50/50 pb-20">
			...
			{/* --- QUICK STATS BAR --- */}
			{/* --- SLIM QUICK STATS BAR --- */}
			<div className="max-w-7xl mx-auto px-6 -mt-8 relative z-20">
				<div className="grid grid-cols-1 md:grid-cols-3 gap-3">
					{/* Emergency Contact - Slim Version */}
					...
					{/* Actions - Height Matched */}
					<div className="flex gap-2 h-[66px]">
						{" "}
						{/* Explicit height matching the cards above */}
						...
						>
							<section className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm">
								<h3 className="text-xl font-bold mb-4 flex items-center gap-2">
									<Info className="w-5 h-5 text-blue-600" /> About the
									Institution
								</h3>
								<p className="text-slate-600 leading-relaxed text-lg">
									{hospital.detail ||
										"Islamia Hospital Bangladesh is committed to providing comprehensive healthcare services with state-of-the-art facilities and a patient-centric approach."}
								</p>
							...
							<section>
								<h3 className="text-xl font-bold mb-6 flex items-center gap-2">
									<Activity className="w-5 h-5 text-blue-600" /> Hospital
									Gallery
								</h3>
										...
										<tbody className="divide-y divide-slate-50">
											{hospital.testPrices?.length > 0 ? (
												...
												<tr>
													...
													>
														No pricing data currently available for this
														hospital.
													</td>
												</tr>
											)}
        ...
        <div className="text-center py-20 bg-white rounded-[2rem] border border-dashed border-slate-200">
            ...
            <p className="text-slate-400 font-bold">No doctors listed for this hospital yet.</p>
				...
				<div className="lg:col-span-4 space-y-8">
					...
					<Card className="rounded-[2.5rem] border-slate-200/60 shadow-sm overflow-hidden bg-white">
						...
						<CardContent className="p-8 pt-0 space-y-6">
							...
							<div className="relative h-48 w-full rounded-3xl overflow-hidden border border-slate-100 group cursor-pointer">
								{/* Placeholder for Map - Could be replaced with a static Google Maps image API */}
							...
							<div className="space-y-4">
								<div className="flex gap-4">
									...
									<Button
										variant="ghost"
										size="icon"
										className="text-slate-400 hover:text-blue-600 rounded-xl bg-slate-50"
									>
					...
					{/* Reviews Section - Modern Light Style */}
